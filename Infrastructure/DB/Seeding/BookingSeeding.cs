    ...
    public class BookingSeeding
    {
            ...
            return new List<Booking>
        {
            new()
            {
                ...
                BookingDate = DateTime.Parse("2025-01-10")
            },
            new()
            {
                ...
                BookingDate = DateTime.Parse("2025-01-28")
            },
            new()
            {
                ...
                Price = 200,
                CheckInDate = DateTime.Parse("2025-03-12"),
                CheckOutDate = DateTime.Parse("2025-03-18"),
                BookingDate = DateTime.Parse("2025-03-05")
            }
        };
        }
    }
